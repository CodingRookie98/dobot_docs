...
} ...
{
    ...
    "jsonrpc": "2.0",
    "params": {
        "message":"rDownloading ISP: |============================-----------------| 63.1% 9kiB/sr"
    }
} ...
{
    "method": "dobotLink.download.process",
    "jsonrpc": "2.0",
    "params": {
        "message":"rDownloading ISP: |=============================================| 100.0% 9kiB/srrnu001b[32mu001b[1m[INFO]u001b[0m Booting From 0x80000000 u001b[0mrnu001b[32mu001b[1m[INFO]u001b[0m Wait For 0.1 second for ISP to Boot u001b[0mrn"
    }
}
```
