...
border="0"}](GetJOGCoordinateParams.html "Previous topic")[![Next
topic](../../template2/btn_next_n.gif){#winchm_template_next
border="0"}](GetJOGCommonParams.html "Next topic")
:::
...
::: {#nstext}
[**设置点动公共参数**]{style="FONT-SIZE: 10.45pt; FONT-FAMILY: 宋体; COLOR: rgb(0,0,0); mso-spacerun: 'yes'"}
...
请求参数 params
  ...
   velocityRatio        float     是           速度比例，关节点动和坐标轴点动共用 （0-100）单位：%
   accelerationRatio    float     是           加速度比例，关节点动和坐标轴点动共用 （0-100）单位：%
